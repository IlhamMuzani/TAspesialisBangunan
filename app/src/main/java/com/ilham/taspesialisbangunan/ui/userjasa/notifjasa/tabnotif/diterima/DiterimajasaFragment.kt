package com.ilham.taspesialisbangunan.ui.userjasa.notifjasa.tabnotif.produkjasa.tabjasa.diterima
...
class DiterimajasaFragment : Fragment(), DiterimajasaContract.View {
    ...
    lateinit var diterimajasaAdapter: MenunggujasaAdapter
...
//        (activity as AppCompatActivity).supportActionBar!!.hide()
        ...
        diterimajasaAdapter = MenunggujasaAdapter(requireActivity(), arrayListOf()){
        ...
        swipeDiterimajasa.setOnRefreshListener {
            presenter.getPengajuanditerimajasa(prefsManager.prefsId)
        }
    }
