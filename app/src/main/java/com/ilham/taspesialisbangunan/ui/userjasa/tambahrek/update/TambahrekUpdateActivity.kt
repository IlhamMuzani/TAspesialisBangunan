...
class TambahrekUpdateActivity : AppCompatActivity(), TambahrekUpdateContract.View {
    ...
    lateinit var databank: DataTambahrek
    ...
    override fun initActivity() {
        tv_bgjasa.text="Ubah No Rekening"
    ...
    override fun initListener() {
        ...
        BTN_savetambahrek.setOnClickListener {
            ...
            if (  norek.isNullOrEmpty() || nama.isNullOrEmpty() ) {
                showMessage("Lengkapi Data Benar")
            } else if ( Constant.BANK_ID == 0){
            } else {
                presenter.updateTambahrek(Constant.TAMBAHREK_ID, Constant.BANK_NAME, norek.toString(), nama.toString())
            }
        }
    }
    ...
    override fun onResultDetailTambahrek(responseTambahrekDetail: ResponseTambahrekDetail) {
        ...
        databank = responseTambahrekDetail.dataTambahrek

//        edtJenisBank.setText( tambahrek.jenis_bank )
        edtNorek.setText( databank.norek )
        edtAtasnama.setText( databank.nama )
        spinnerrekeningupdate()
...
//        GlideHelper.setImage(this, "http://192.168.43.224/api_spesialisJB/public/"+ material.gambar!!, imvImageMaterial)
    ...
    fun spinnerrekeningupdate() {
        ...
        val selection = adapter.getPosition(databank.jenis_bank)
