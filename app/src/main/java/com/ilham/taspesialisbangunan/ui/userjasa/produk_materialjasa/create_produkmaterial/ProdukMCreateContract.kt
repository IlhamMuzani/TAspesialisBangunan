...
interface ProdukMCreateContract {

    interface Presenter {
        fun insertProdukMaterial(kd_user: String,nama_toko: String, jenis_pembuatan: String, alamat: String, phone: String, harga: String,
